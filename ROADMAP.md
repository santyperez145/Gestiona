...
| **C9** Multi-depósito real en la tienda | 🟡 La tienda ya reserva, vende y devuelve desde una sucursal configurada, con detalle por variante. Falta C9a para distribuir variantes entre depósitos y usarlo con un segundo comercio. |
...
| **C9** | **Multi-depósito real en la tienda** | 🟡 Slice 49: la tienda elige depósito de despacho; la orden toma una foto inmutable y reserva, venta, devolución y Kardex respetan esa ubicación incluso para variantes. Las reservas globales antiguas bloquean conservadoramente. Falta C9a para distribuir variantes entre depósitos desde la operación. | Shopify |
| **C9a** | **Transferencias de variantes entre depósitos** | 🔴 El transferidor actual mueve sólo el producto agregado. Agregar selección de variante, validación por `location_variant_stock`, dos asientos de Kardex y UI de sucursales; no inferir ni repartir el stock existente entre varias ubicaciones. | — |
