...
| **C9** Multi-depósito real en la tienda | 🟡 La tienda reserva, vende, devuelve y redistribuye variantes por sucursal. Falta C9b para cargar/ajustar una variante con ubicación explícita y usarlo con un segundo comercio. |
...
| **C9** | **Multi-depósito real en la tienda** | 🟡 Slices 49–50: la tienda elige depósito de despacho; la orden toma una foto inmutable y reserva, venta, devolución, Kardex y transferencia respetan esa ubicación incluso para variantes. Las reservas globales antiguas bloquean conservadoramente. Falta C9b para ingresos/ajustes de variantes por depósito. | Shopify |
...
| **C9b** | **Ingreso y ajuste de variante por depósito** | 🔴 Al crear o ajustar stock de una variante con más de una sucursal, la UI/RPC actual todavía no exige ubicación. Agregar selección explícita y un movimiento por Kardex; nunca distribuir automáticamente entre depósitos. | — |
