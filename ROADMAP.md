...
|---|---|---|
| 1 | Platform Overview | **Slice inicial completado 2026-08-21:** el Resumen conecta `platform_org_health`, `platform_org_activation` y `platform_cron_health` para GMV/cobros 30d, adopción POS/tienda, omnicanalidad, riesgos y cron. Muestra “sin evidencia” o error explícito; faltan pagos, webhooks, colas y errores como señales de primer nivel. |
...
| Tests | Anda | **1200** (`npm test -- --maxWorkers=1 --fileParallelism=false`, 2026-08-21) + E2E de tienda |
...
| Tests | 1200 (`npm test -- --maxWorkers=1 --fileParallelism=false`) |
