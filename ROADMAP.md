...
|---|---|
| Calidad técnica | 1.487 tests en 134 archivos pasan al 2026-08-22; typecheck, lint y build/PWA verdes; 65 Edge Functions verificadas. 42 E2E críticos (32 públicos, 9 de panel y setup autenticado) conservan su última evidencia contra la base real. |
...
35. ~~Paginación canónica D2.4~~ — cerrada técnicamente el 2026-08-22 en los
    ...
    pruebas y la guarda visual impide que esas páginas vuelvan a divergir. D2.4
    sigue parcial: quedan 83 campos date/datetime/month en 46 archivos y 16
    inputs de archivo por clasificar antes de fijar primitives obligatorios.
...
- Build y suites locales del 2026-08-22: 1.487 tests en 134 archivos, typecheck,
