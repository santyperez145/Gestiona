...
197. La tienda online pasa a ser la puerta visible de Nerqia — D5.38,
     ...
     prueba. La matriz final pasó **10/10** en Chromium/mobile a
     360/768/1024/1440, sin overflow y con Axe WCAG A/AA sin impactos críticos o
     serios. La inspección de localhost confirmó foto cargada, las tres señales,
     siguiente sección visible y ancho 1.136/1.140. Se retiró además una prop de
     prioridad no soportada que React reportaba en consola. Puerta completa:
     typecheck, lint con **0 errores/142 warnings conocidos**, **2.718 tests en
     296 archivos** (`npm test`, 2026-09-04) y build/PWA; CSS en **49,32 kB
