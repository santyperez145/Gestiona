...
build/PWA; falta la matriz publicada para cerrar el slice.
...
- carrito y checkout: D5.30 evita el resumen completo sticky en checkout y
  ...
  conserva el cotizador y declara `+ envío`; falta su matriz publicada;
