...
Está pendiente publicar ese segundo ajuste y repetir la ficha; axe tampoco
sustituye teclado, zoom o lector de pantalla.
...
| 22 | Accesibilidad AA | Parcial D6.1 2026-09-04 | Gate axe WCAG A/AA para Inicio, PLP, PDP, carrito y checkout; la primera corrida publicada encontró contraste 2,13:1/1,19:1. El contrato central corrigió 8/10 desktop/mobile y la segunda corrida detectó dos links de PDP distinguibles sólo por color, ya subrayados. Falta publicar ese ajuste, teclado, zoom, todos los temas y lector de pantalla. |
