...
cinco pruebas focales protegen bootstrap, semántica y deduplicación. Falta puerta
publicada y señal real en los diagnósticos del proveedor; la puerta local pasó
TypeScript, lint con 0 errores/142 warnings conocidos, 2.670 tests en 287
archivos y build/PWA. No se declara Events API/CAPI.
