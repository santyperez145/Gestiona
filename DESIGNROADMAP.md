...
- D2.4 unificó los cinco paginadores manuales de Admin, Productos, Compras,
  ...
  `aria-live` bajo guarda. Quedan 83 fechas en 46 archivos y 16 inputs de archivo
  por clasificar, no para reemplazarlos en masa;
...
- [ ] D2.4 — **parcial 2026-08-22:** paginación cerrada en los cinco listados que
  la duplicaban; faltan clasificación y convergencia deliberada de fechas,
  uploader, combobox y menús.
...
## 6. Próximos 23 slices de diseño
...
| 9 | Productos end-to-end | Pendiente | Desktop/mobile + editor/importación. |
| 10 | Ventas y devolución | Pendiente | Lista→detalle→acción sin perder filtros. |
| 11 | POS teclado/touch/offline | Pendiente | Cobro y recuperación medidos. |
| 12 | Compras, recepción y Kardex | Parcial 2026-08-22 | Finance llega a la OC exacta, muestra contexto y abre la recepción idempotente; faltan Kardex integrado y matriz responsive. |
| 13 | Reportes orientados a decisión | Pendiente | Menos filtros duplicados; acción clara. |
| 14 | Settings e Integraciones | Pendiente | Secretos, permisos y estados consistentes. |
| 15 | Finance Document Inbox | Parcial 2026-08-22 | Cola, retry, bloqueo, cuarentena, confianza, revisión, matching y diálogo Supplier Invoice/Purchase/Payable Draft visibles. Líneas, vencimiento, TC, efectos, aprobación y handoff a recepción usan estados claros; faltan proveedor OCR aprobado y validación responsive con documentos reales. |
| 16 | Finance command center Mendel-class | Congelado hasta adopción F3 | Inicio, gastos, solicitudes/aprobaciones, presupuestos/políticas, medios, centros, conciliación e integraciones completan desktop/mobile con estados y autoridad visibles. |
| 17 | Platform Merchant 360/cola | Pendiente | Staff resuelve sin entrar al tenant. |
| 18 | Storefront home/PLP/PDP | Pendiente | Marca, performance y mobile aprobados. |
| 19 | Carrito/checkout/pago | Pendiente | Compra completa 360 px/red lenta. |
| 20 | Accesibilidad AA | Pendiente | axe + teclado + zoom + contraste. |
| 21 | Visual regression CI | Pendiente | Capturas deterministas claro/oscuro. |
| 22 | Pruebas con comercios | Bloqueado externamente | Tareas reales y hallazgos registrados. |
| 23 | Investor demo mode con datos seguros | Pendiente tras validación | Narrativa reproducible, sin métricas falsas. |
