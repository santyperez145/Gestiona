...
archivos, tipos, lint sin errores y build/PWA; falta medir el bundle publicado
en Chromium y Pixel 5 para cerrar la matriz.
...
- carrito y checkout: objetivos táctiles hechos; D5.30 evita el resumen completo
  sticky y reserva sólo Total + acción en 360 px; falta matriz publicada;
