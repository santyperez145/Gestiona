...
- operación de órdenes: búsqueda, vistas, CSV, inspector y bulk parcial con
  ...
  TypeScript, lint sin errores y build/PWA. Falta certificar el layout publicado
  y compra sandbox/real;
