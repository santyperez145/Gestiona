...
| Ventas/POS | Lista/Rendimiento; POS fullscreen deliberado. La cola offline ya habla en tickets —no líneas— y muestra unidades, monto, antigüedad, sincronización parcial y fallo persistente sin fingir que Gestiona capturó una tarjeta. El reintento conserva una identidad canónica y el servidor devuelve el ticket previo sin duplicar sus efectos. | Parcial D2.5/D3 2026-08-29 | Cobro completo teclado/touch, E2E offline con almacenamiento aislado y medición de tarea. |
