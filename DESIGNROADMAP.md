...
errores recuperables y acciones móviles. El resumen dejó de incrustar pantallas
operativas y ahora prioriza KPIs, campañas recientes y próximos pasos.
...
| Commerce admin | Configuración, rendimiento, voz, catálogo, páginas, diseño, pagos/envíos. | Selector y contexto de tienda compartidos por Configuración, Pedidos y Recuperación; la selección persiste en URL. | Surtido multi-tienda y responsive autenticado. |
