...
| Gastos | Tabla/cards y formulario unificados; comprobante privado con captura inline, disclosure previo, sugerencias estructuradas, revisión humana, error accionable y alternativa manual. El archivo queda local hasta confirmar el gasto; la extracción documental está apagada por flag mientras falten contrato y proveedor aprobados. | Parcial D2.5/D3 2026-08-30 | Validar 360/768/1024/1440 y benchmark de lectura/costo con comprobantes autorizados antes de habilitar IA. |
...
- [x] El escáner deja de usar el chat SSE como OCR y pasa a un contrato
  ...
  separado conserva todo apagado hasta aprobar privacidad/proveedor; faltan la
  matriz responsive publicada y la prueba real autorizada (2026-08-30).
