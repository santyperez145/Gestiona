...
| 28 | Contrato visible de API pública | Hecho 2026-08-29 | Panel, estado vacío y modal verificados con sesión de administrador real en producción: claro/oscuro, 360/768/1024/1440, cero overflow y consola sin warnings/errors. Guía, OpenAPI 3.1 y changelog accesibles; secretos one-time sin bloque negro en claro. La prueba descubrió que `stock:write` ocultaba parte de su consecuencia en mobile y ahora la descripción envuelve completa. Evidencia: `docs/evidencias/2026-08-29_api_keys_visual.md`. |
