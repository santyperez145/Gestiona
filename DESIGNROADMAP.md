...
| Storefront | Marca configurable aislada del SaaS; imágenes rotas degradan a fallbacks propios. El resultado de compra separa carga, acceso verificado y recuperación por email sin revelar si un número existe; pago y emails comparten la misma capacidad server-side. La comunicación transaccional distingue creación, pago y despacho y responde retries/dobles clicks como éxito deduplicado, no como otra entrega. | Parcial D5 2026-09-01 | D5.1–D5.8: cola, inspector, CTA a 360 px y skeleton sin chrome SaaS. Faltan bulk con autoridad, red lenta y compra sandbox/real. |
...
| 20 | Storefront home/PLP/PDP | Parcial D5.8 2026-09-01 | D5.1 cubre resiliencia de banners, hero, categorías, cards, PDP, búsqueda, logo, carrito y sugerencias. D5.7 deja el CTA de compra al pie en 360 px. D5.8 reserva geometría al cargar y declara tamaño de imagen. Falta hero del comercio, red lenta y flujo sandbox/real. |
