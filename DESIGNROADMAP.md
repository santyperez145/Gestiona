...
nueva no puede atribuirse hacia atrás. La matriz visual queda lista para deploy;
la autoridad productiva se probó dos veces sobre un token anónimo y dejó un
solo timestamp y 0 residuos. Quedan período, comparación y canal.
