...
|---|---|---|
| Shopify | ✅ Inventario separado por ubicación, order routing y POS que descuenta en la ubicación elegida ([Locations](https://help.shopify.com/en/manual/fulfillment/setup/locations), [POS inventory](https://help.shopify.com/en/manual/sell-in-person/shopify-pos/inventory-management/products)), consultado 2026-09-04. | Stock único por ubicación y fulfillment explícito; no copiar su admin. |
| Tiendanube | ✅ Punto de Venta busca catálogo/clientes, aplica descuentos y crea órdenes usando el mismo stock ([Punto de Venta](https://ayuda.tiendanube.com/pdv/que-es-punto-de-venta-de-tiendanube)); recuperación automática de checkout ([carritos](https://ayuda.tiendanube.com/es_AR/123339-carritos-abandonados/como-recuperar-los-carritos-abandonados)), consultado 2026-09-04. | Paridad regional en operación omnicanal y recuperación; ventaja en costo/margen conectado. |
