...
| Tests unitarios | **1.983** | ✅ `npm test -- --maxWorkers=1 --fileParallelism=false`, 192 archivos, 2026-08-29 |
...
| **CI** | ✅ Deno para 71 Edge Functions + lint + typecheck + build, 1.983 tests en 192 archivos (2026-08-29), audit completo en 0 y 43 E2E críticos bloqueantes (tienda desktop/móvil + panel autenticado) | Suite completa bloqueante, incluidos los E2E y el código serverless | 🟢 Cerrado para los recorridos definidos |
