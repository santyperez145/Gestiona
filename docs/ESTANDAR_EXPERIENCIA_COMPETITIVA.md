...
| Square | ✅ [reportes](https://squareup.com/help/us/en/article/5072-summaries-and-reports-from-the-online-dashboard), [colas de disputa](https://squareup.com/help/us/en/article/8361-view-dispute-reports) y [pagos offline](https://squareup.com/help/us/en/article/7777-process-card-payments-with-offline-mode) | Fecha/local/dispositivo como contexto; tarjetas de performance y lista accionable; “requiere respuesta”. Offline declara estado pendiente, riesgo, ventana de carga y resultado al reconectar; no presenta una captura local como cobro confirmado. | POS/reportes por ubicación y colas con severidad, dueño, vencimiento y próxima acción. Gestiona agrupa la cola offline por ticket, expone monto/antigüedad/error y reintenta idempotente; como no procesa la tarjeta, dice que el cobro ocurre por fuera en vez de copiar la promesa de hardware de Square. |
