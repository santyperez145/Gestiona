...
function CampaignCalendar({ onGeneratePost }: { onGeneratePost: (theme: string) => void }) {
  ...
  const dates: CampaignDate[] = [
    ...
    { date: new Date(year, 2, 8), name: 'Día de la Mujer', emoji: '💜', color: 'text-primary border-purple-500/30 bg-purple-500/10', ideas: ['Foco en fragancias femeninas', 'Mensaje de empoderamiento', 'Pack especial para regalar', 'Descuento en línea mujer'] },
