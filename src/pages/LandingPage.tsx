...
const SURFACES = [
  ...
  },
  {
    ...
    description: 'Productos, POS (offline incluido), ventas, compras, clientes e inventario comparten autoridad. Cada movimiento actualiza el resto del sistema sin conciliaciones manuales, y la ficha del cliente unifica todo su historial: ventas, pedidos online, notas, WhatsApp y deudas en un solo timeline.',
    facts: ['Stock por sucursal', 'POS usable sin conexión', 'Ficha del cliente con timeline 360'],
    icon: Layers3,
    tone: 'berry',
  },
  {
