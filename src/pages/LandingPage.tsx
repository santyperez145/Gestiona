...
const CAPABILITIES = [
  ...
  },
  {
    ...
    description: 'POS con o sin conexión, clientes sin duplicados y stock único. Productos, ventas, compras y entregas comparten autoridad para que el equipo trabaje sobre la misma verdad.',
    tone: 'teal',
  },
  {
    ...
    description: 'Costo, comisión, envío e impuestos explican cuánto dejó cada producto, pedido y canal. Conciliación bancaria con extracto real y exportación contable para el contador.',
    tone: 'ink',
  },
  {
    icon: Sparkles,
    ...
    description: 'Brief, aceptación, entregas con revisión, publicación verificada con licencia y chat por colaboración. Los retiros se pagan automáticamente vía Mercado Pago.',
    tone: 'berry',
  },
] as const;
...
const SURFACES = [
  {
    ...
    description: 'Diseño por bloques con título y cantidad propios — como las secciones de Shopify —, catálogo, variantes, promociones, checkout, pagos, envíos y medición conectados con la operación real.',
    facts: ['Bloques de portada configurables', 'Checkout, pagos y envíos', 'Pedidos conectados al stock'],
    icon: Store,
    tone: 'coral',
  },
  {
    ...
    description: 'Productos, POS (offline incluido), ventas, compras, clientes e inventario comparten autoridad. Cada movimiento actualiza el resto del sistema sin conciliaciones manuales.',
    facts: ['Stock por sucursal', 'POS usable sin conexión', 'Clientes sin duplicados'],
    icon: Layers3,
    tone: 'berry',
  },
  {
    ...
    description: 'Documentos, gastos, obligaciones, caja y conciliación se conectan con la operación sin duplicar ventas, clientes ni inventario. Importá el extracto del banco, confirmá los matches contra el libro y exportá el asiento para el contador.',
    facts: ['Conciliación bancaria real', 'Exportación contable auditada', 'Rentabilidad por canal'],
    icon: WalletCards,
    tone: 'teal',
  },
  {
    ...
    title: 'Campañas con creadores, de la invitación al pago.',
    description: 'Invitá, coordiná por chat, revisá entregas y verificá la publicación con su licencia de uso. El creador cobra sus comisiones con retiros pagados automáticamente vía Mercado Pago.',
    facts: ['Chat por colaboración', 'Publicación verificada con licencia', 'Retiros automáticos vía Mercado Pago'],
    icon: Sparkles,
    tone: 'berry',
  },
] as const;
