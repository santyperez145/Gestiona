...
export const ROUTES: RouteDefinition[] = [
  ...
  { id: "influencer-marketing", path: "/influencer-marketing", roles: SOLO_ADMIN, component: lazy(() => import("@/pages/InfluencerMarketingPage")), module: "influencers", status: "canonical", nav: { label: "Influencer Marketing", icon: Target, group: "influencer-marketing", keywords: ["influencer", "marketing", "plataforma"] }, productSurface: "influencer-marketing" },
  { id: "influencer-contracts", path: "/influencer-contracts", roles: SOLO_ADMIN, component: lazy(() => import("@/pages/InfluencerContractsPage")), module: "influencers", status: "canonical", nav: { label: "Contratos", icon: FileText, group: "influencers", keywords: ["contratos", "acuerdos", "legal"] }, productSurface: "influencer-marketing" },
  { id: "influencer-deliverables", path: "/influencer-deliverables", roles: SOLO_ADMIN, component: lazy(() => import("@/pages/InfluencerDeliverablesPage")), module: "influencers", status: "canonical", nav: { label: "Entregables", icon: Calendar, group: "influencers", keywords: ["entregables", "fechas", "entregas"] }, productSurface: "influencer-marketing" },
  { id: "influencer-payments", path: "/influencer-payments", roles: SOLO_ADMIN, component: lazy(() => import("@/pages/InfluencerPaymentsPage")), module: "influencers", status: "canonical", nav: { label: "Pagos", icon: DollarSign, group: "influencers", keywords: ["pagos", "comisiones", "liquidaciones"] }, productSurface: "influencer-marketing" },
  { id: "brand-portal", path: "/brand-portal", roles: SOLO_ADMIN, component: lazy(() => import("@/pages/InfluencerBrandPortalPage")), module: "influencers", status: "canonical", nav: { label: "Brand Portal", icon: Building2, group: "influencers", keywords: ["brand", "marca", "colaboradores"] }, productSurface: "influencer-marketing" },
