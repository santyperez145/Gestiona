...
export const ROUTES: RouteDefinition[] = [
  ...
  { id: "pedidos_online", path: "/pedidos-online", roles: AMBOS, component: lazy(() => import("@/pages/StoreOrdersPage")), module: "ecommerce", aliases: [{ path: "/tienda-online/pedidos", redirectTo: "/pedidos-online" }], status: "canonical", nav: { label: "Pedidos online", icon: ShoppingCart, group: "diario", keywords: ["pedidos online", "ecommerce orders", "despachar", "tienda web", "checkout", "ordenes tienda"] } },
