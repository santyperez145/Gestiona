...
import {
  ...
  Users2, Wallet, Warehouse, Zap, Target,
} from "lucide-react";
...
export const ROUTES: RouteDefinition[] = [
  ...
  { id: "deudas", path: "/deudas", roles: SOLO_ADMIN, component: lazy(() => import("@/pages/DebtsPage")), module: "sales", status: "canonical", nav: { label: "Deudas", icon: AlertCircle, group: "finance", keywords: ["me deben", "cuentas por cobrar", "fiado", "moroso"] } },
  { id: "cuotas", path: "/cuotas", roles: SOLO_ADMIN, component: lazy(() => import("@/pages/CuotasPage")), module: "sales", status: "canonical", nav: { label: "Cuotas", icon: CreditCard, group: "finance", keywords: ["financiación", "plan de pago", "vencimientos"] } },
  { id: "presupuestos", path: "/presupuestos", roles: SOLO_ADMIN, component: lazy(() => import("@/pages/PresupuestosPage")), module: "sales", status: "canonical", nav: { label: "Presupuestos", icon: ClipboardList, group: "finance", keywords: ["cotización", "quotes", "proforma"] } },
  { id: "facturas", path: "/facturas", roles: SOLO_ADMIN, component: lazy(() => import("@/pages/InvoicesPage")), module: "invoices", status: "canonical", nav: { label: "Facturas", icon: FileText, group: "finance", keywords: ["comprobantes", "invoices"] } },
  { id: "devoluciones", path: "/devoluciones", roles: SOLO_ADMIN, component: lazy(() => import("@/pages/DevolucionesPage")), module: "sales", aliases: [{ path: "/devoluciones-rma", redirectTo: "/devoluciones" }], status: "canonical", nav: { label: "Devoluciones", icon: RotateCcw, group: "finance", keywords: ["cambios", "rma", "reembolso"] } },
  ...
  { id: "banco", path: "/finance/banco", roles: SOLO_ADMIN, component: lazy(() => import("@/pages/BankReconciliationPage")), module: "finance", aliases: [{ path: "/banco", redirectTo: "/finance/banco" }, { path: "/finance/banco/reconciliacion", redirectTo: "/finance/banco" }], status: "canonical", productSurface: "finance", nav: { label: "Banco y conciliación", icon: Landmark, group: "finance", keywords: ["conciliar", "reconciliación", "match bancario", "extracto", "estado cuenta", "movimientos bancarios", "exportación contable", "ARCA"] } },
  ...
  { id: "afiliados", path: "/afiliados", roles: SOLO_ADMIN, component: lazy(() => import("@/pages/AffiliateProgramPage")), module: "marketing", status: "canonical", nav: { label: "Afiliados", icon: UserPlus, group: "marketing", keywords: ["partners", "socios", "comisiones", "conversiones"] } },
  { id: "referidos", path: "/referidos", roles: SOLO_ADMIN, component: lazy(() => import("@/pages/ReferralsPage")), module: "marketing", status: "canonical", nav: { label: "Referidos de clientes", icon: Share2, group: "marketing", keywords: ["referrals", "boca a boca", "bonos", "recompensas"] } },
  { id: "influencer-marketing", path: "/influencer-marketing", roles: SOLO_ADMIN, component: lazy(() => import("@/pages/InfluencerMarketingPage")), module: "influencers", status: "canonical", nav: { label: "Resumen", icon: LayoutDashboard, group: "influencer-marketing", keywords: ["influencer", "marketing", "plataforma", "creadores"] }, productSurface: "influencer-marketing" },
  { id: "influencer-campaigns", path: "/influencer-marketing/campanas", roles: SOLO_ADMIN, component: lazy(() => import("@/pages/CampaignsPage")), module: "influencers", status: "canonical", nav: { label: "Campañas", icon: Megaphone, group: "influencer-marketing", keywords: ["campaigns", "activas", "presupuesto", "invitaciones"] }, productSurface: "influencer-marketing" },
  { id: "influencers", path: "/influencer-marketing/creadores", roles: SOLO_ADMIN, component: lazy(() => import("@/pages/InfluencersPage")), module: "influencers", aliases: [{ path: "/influencers", redirectTo: "/influencer-marketing/creadores" }], status: "canonical", nav: { label: "Creadores", icon: Users2, group: "influencer-marketing", keywords: ["influencers", "instagram", "tiktok", "discovery"] }, productSurface: "influencer-marketing" },
  { id: "creator-discovery", path: "/influencer-marketing/descubrir", roles: SOLO_ADMIN, component: lazy(() => import("@/pages/CreatorDiscoveryPage")), module: "influencers", status: "canonical", nav: { label: "Descubrir", icon: ScanSearch, group: "influencer-marketing", keywords: ["discovery", "buscar creadores", "audiencia", "engagement"] }, productSurface: "influencer-marketing" },
  { id: "campaign_matching", path: "/influencer-marketing/matching", roles: SOLO_ADMIN, component: lazy(() => import("@/components/marketing/CampaignMatching")), module: "influencers", aliases: [{ path: "/campaign-matching", redirectTo: "/influencer-marketing/matching" }], status: "canonical", nav: { label: "Matching", icon: Target, group: "influencer-marketing", keywords: ["campañas", "match", "colaboración", "selección"] }, productSurface: "influencer-marketing" },
  { id: "brief_composer", path: "/influencer-marketing/briefs", roles: SOLO_ADMIN, component: lazy(() => import("@/components/marketing/BriefComposer")), module: "influencers", aliases: [{ path: "/brief-composer", redirectTo: "/influencer-marketing/briefs" }], status: "canonical", nav: { label: "Briefs", icon: Sparkles, group: "influencer-marketing", keywords: ["brief composer", "ia", "campaña", "guion"] }, productSurface: "influencer-marketing" },
  { id: "canjes", path: "/influencer-marketing/colaboraciones", roles: SOLO_ADMIN, component: lazy(() => import("@/pages/InfluencerExchangesPage")), module: "influencers", aliases: [{ path: "/canjes", redirectTo: "/influencer-marketing/colaboraciones" }, { path: "/liquidaciones", redirectTo: "/influencer-marketing/colaboraciones" }], status: "canonical", nav: { label: "Colaboraciones", icon: Gift, group: "influencer-marketing", keywords: ["canjes", "campañas", "regalos", "prensa"] }, productSurface: "influencer-marketing" },
  { id: "influencer-contracts", path: "/influencer-marketing/contratos", roles: SOLO_ADMIN, component: lazy(() => import("@/pages/InfluencerContractsPage")), module: "influencers", aliases: [{ path: "/influencer-contracts", redirectTo: "/influencer-marketing/contratos" }], status: "canonical", nav: { label: "Contratos", icon: FileText, group: "influencer-marketing", keywords: ["acuerdos", "legal", "derechos"] }, productSurface: "influencer-marketing" },
  { id: "influencer-deliverables", path: "/influencer-marketing/entregables", roles: SOLO_ADMIN, component: lazy(() => import("@/pages/InfluencerDeliverablesPage")), module: "influencers", aliases: [{ path: "/influencer-deliverables", redirectTo: "/influencer-marketing/entregables" }], status: "canonical", nav: { label: "Entregables", icon: Calendar, group: "influencer-marketing", keywords: ["contenido", "fechas", "aprobaciones", "video reviewer"] }, productSurface: "influencer-marketing" },
  { id: "influencer-payments", path: "/influencer-marketing/pagos", roles: SOLO_ADMIN, component: lazy(() => import("@/pages/InfluencerPaymentsPage")), module: "influencers", aliases: [{ path: "/influencer-payments", redirectTo: "/influencer-marketing/pagos" }], status: "canonical", nav: { label: "Pagos", icon: DollarSign, group: "influencer-marketing", keywords: ["comisiones", "liquidaciones", "creadores"] }, productSurface: "influencer-marketing" },
  { id: "brand-portal", path: "/influencer-marketing/portal-marca", roles: SOLO_ADMIN, component: lazy(() => import("@/pages/InfluencerBrandPortalPage")), module: "influencers", aliases: [{ path: "/brand-portal", redirectTo: "/influencer-marketing/portal-marca" }], status: "canonical", nav: { label: "Portal de marca", icon: Building2, group: "influencer-marketing", keywords: ["brand portal", "marca", "colaboradores"] }, productSurface: "influencer-marketing" },
