...
export const ROUTES: RouteDefinition[] = [
  ...
  { id: "afip", path: "/afip", roles: SOLO_ADMIN, component: lazy(() => import("@/pages/AFIPPage")), module: "invoices", status: "canonical", nav: { label: "ARCA y factura electrónica", icon: Shield, group: "finanzas", keywords: ["arca", "afip", "cae", "facturar", "wsfe", "monotributo"] } },
