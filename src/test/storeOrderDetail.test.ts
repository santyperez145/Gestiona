...
describe("inspector de un pedido de tienda", () => {
  ...
  it("nombra el medio de cobro; Nerqia Pay, no mercadopago crudo", () => {
    expect(storeOrderPaymentMethodLabel("gestiona_pay")).toBe("Nerqia Pay");
    expect(storeOrderPaymentMethodLabel("mercadopago")).toBe("Nerqia Pay");
