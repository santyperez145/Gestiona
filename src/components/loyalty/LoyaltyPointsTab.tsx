...
const TIERS = [
  ...
  { name: "Plata", min: 100, max: 499, color: "text-muted-foreground", bg: "bg-muted/15", barColor: "bg-muted" },
          ...
          {selected && selectedBalance ? (
            <div className="bg-card border border-border/60 rounded-[10px] p-5 space-y-4">
              ...
              {(() => {
                ...
                if (!next) return <p className="text-xs text-primary font-medium">¡Nivel máximo alcanzado! 🏆</p>;
