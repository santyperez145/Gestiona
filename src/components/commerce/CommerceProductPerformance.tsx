/**
 * CommerceProductPerformance — Rendimiento de productos para el dashboard de Commerce
 *
...
interface CommerceProductPerformanceProps {
...
export default function CommerceProductPerformance({
  products,
  title = "Rendimiento de Productos",
}: CommerceProductPerformanceProps) {
