    ...
    <>
      ...
      <button
        ...
        className={cn(
          ...
          "bg-card border border-border hover:border-primary/50 hover:shadow-xl hover:scale-105",
      ...
      {open && (
        <>
          ...
          {/* Panel */}
          <div className="fixed right-0 top-0 bottom-0 z-50 w-full max-w-[360px] flex flex-col bg-card border-l border-border shadow-2xl animate-in slide-in-from-right duration-200">
