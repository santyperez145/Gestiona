...
const allNavItems = [
  ...
  { to: "/territorios", label: "Territorios", icon: Map, roles: ['admin'], section: 'ventas' },
  ...
  { to: "/metas", label: "Metas de Ventas", icon: Target, roles: ['admin'], section: 'finanzas' },
  { to: "/fichajes", label: "Fichajes & RRHH", icon: Clock, roles: ['admin'], section: 'finanzas' },
  ...
  { to: "/gamificacion", label: "Gamificación", icon: Trophy, roles: ['admin'], section: 'analytics' },
  ...
  { to: "/recetas", label: "Fichas Técnicas / BOM", icon: ChefHat, roles: ['admin'], section: 'inventario' },
  { to: "/alquileres", label: "Gestión de Alquileres", icon: Building2, roles: ['admin'], section: 'ventas' },
  { to: "/marketplace", label: "Marketplace & Canales", icon: ShoppingBag, roles: ['admin'], section: 'ventas' },
  { to: "/sueldos", label: "Sueldos & RRHH", icon: Users2, roles: ['admin'], section: 'finanzas' },
  { to: "/impuestos", label: "Gestión Impositiva", icon: Scale, roles: ['admin'], section: 'finanzas' },
  { to: "/flota", label: "Flota Vehicular", icon: Car, roles: ['admin'], section: 'finanzas' },
  { to: "/activos-fijos", label: "Activos Fijos", icon: Landmark, roles: ['admin'], section: 'finanzas' },
  { to: "/tarjetas-regalo", label: "Tarjetas de Regalo", icon: Gift, roles: ['admin'], section: 'ventas' },
  { to: "/dropshipping", label: "Dropshipping", icon: PackageSearch, roles: ['admin'], section: 'ventas' },
  ...
  { to: "/fidelidad-avanzada", label: "Fidelidad Avanzada", icon: Crown, roles: ['admin'], section: 'ventas' },
  { to: "/kpi-dashboard", label: "KPI Dashboard", icon: LineChart, roles: ['admin'], section: 'analytics' },
  { to: "/precios-competencia", label: "Inteligencia Competitiva", icon: BarChart3, roles: ['admin'], section: 'analytics' },
  { to: "/rrhh", label: "Portal RRHH", icon: Users2, roles: ['admin'], section: 'finanzas' },
  { to: "/auditoria", label: "Auditoría del Sistema", icon: Shield, roles: ['admin'], section: 'config' },
  { to: "/api-keys", label: "API & Webhooks", icon: Code2, roles: ['admin'], section: 'config' },
  ...
  { to: "/chat-ia-avanzado", label: "Chat IA Avanzado", icon: Sparkles, roles: ['admin'], section: 'ia' },
  { to: "/afip", label: "AFIP / Fact. Electrónica", icon: Shield, roles: ['admin'], section: 'finanzas' },
  { to: "/supply-chain", label: "Supply Chain", icon: Truck, roles: ['admin'], section: 'inventario' },
  ...
  { to: "/customer-journey", label: "Customer Journey", icon: Map, roles: ['admin'], section: 'ventas' },
  { to: "/motor-precios", label: "Motor de Precios", icon: Tag, roles: ['admin'], section: 'inventario' },
  { to: "/ocr-facturas", label: "OCR de Facturas", icon: ScanBarcode, roles: ['admin'], section: 'finanzas' },
